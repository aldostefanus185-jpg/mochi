...
<title>Settings - Daifuku Mochi</title>
...
.form-group input:focus{border-color:#f093fb;background:#fff}
.btn-save{padding:12px 28px;background:linear-gradient(135deg,#f093fb,#f5576c);border:none;border-radius:12px;color:#fff;font-size:14px;font-weight:600;font-family:'Poppins',sans-serif;cursor:pointer;transition:.3s}
.btn-save:hover{box-shadow:0 6px 20px rgba(245,87,108,.4);transform:translateY(-2px)}
